...
with nav_col2:
    st.markdown("""
        <div style="display: flex; justify-content: flex-end; align-items: center;">
            ...
            <span class="nav-pill">📄 PDF Tools</span>
            <span class="nav-pill">🧊 3D Videos</span>
            <span class="nav-pill-active">⏱️ Full Dashboard</span>
        </div>
    """, unsafe_allow_html=True)
...
rul_icon = '<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#2563eb" stroke-width="2.2"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>'
